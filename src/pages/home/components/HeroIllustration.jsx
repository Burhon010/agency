...
export default function HeroIllustration() {
  return (
    <svg viewBox="0 0 400 260" className="size-full" role="img" aria-label="Диаграмма процесса разработки">
      ...
      <g className="hero-float" style={{ '--float-duration': '5s', '--float-delay': '0s' }}>
      ...
      <g className="hero-float" style={{ '--float-duration': '3.6s', '--float-delay': '0.2s' }}>
      ...
      <g className="hero-float" style={{ '--float-duration': '4.4s', '--float-delay': '0.6s' }}>
      ...
      <g className="hero-float" style={{ '--float-duration': '5.2s', '--float-delay': '0.4s' }}>
      ...
      {/* иконка code (зелёная) */}
      <g className="hero-float" style={{ '--float-duration': '3.9s', '--float-delay': '0.9s' }}>
      ...
      <g className="hero-float" style={{ '--float-duration': '5.6s', '--float-delay': '0.3s' }}>
